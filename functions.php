...
function expert_healthcare_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'WooCommerce Widget Area', 'expert-healthcare' ),
		'id' => 'expert-healthcare-woocommerce-sidebar',
		'description' => __( 'This Widget area for WooCommerce Widget', 'expert-healthcare' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h4 class="widget-title">',
		'after_title' => '</h4><div class="title"><span class="shap"></span></div>',
